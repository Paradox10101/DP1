    ...
    return (
        ...
        <div className="flex flex-col p-4 gap-1">
            <div className="flex flex-row justify-between">
                ...
                {
                    status === "REGISTERED"  || status === "PARTIALLY_ASSIGNED"? (
                    ...
                    ) : status === "IN_TRANSIT" || status === "PARTIALLY_ARRIVED" || status === "FULLY_ASSIGNED"? (
            ...
            <div className="flex flex-row justify-between">
                <div className="flex flex-row gap-2 items-center">
                    <Clock size={16}/>
                    <div className="pequenno">Tiempo de atención: {`${timeElapsedDays} d ${String(timeElapsedHours).padStart(2, '0')} h`}</div>
                </div>
            </div>
